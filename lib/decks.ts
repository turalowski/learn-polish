...
const verbs: Question[] = [
  ...
  { id: 36, category: "Próbować — to try", question: "I will try to contact them and ask them to fix it.", answer: "Spróbuję się z nimi skontaktować i poprosić o naprawę." },
  { id: 37, category: "Sprawdzić — to check", question: "I will check the contract and give you the price.", answer: "Sprawdzę umowę i podam cenę." },
  { id: 38, category: "Przesunąć — to move", question: "We should move the sofa so we can install the light.", answer: "Powinniśmy przesunąć sofę, żeby zamontować światło." },
  { id: 39, category: "Udać się — to manage", question: "I was busy yesterday, so today I managed to reply to your message.", answer: "Wczoraj byłem zajęty, więc dziś udało mi się odpowiedzieć na twoją wiadomość." },
  { id: 40, category: "Zejść — to go down", question: "I’ll come downstairs to you in a moment.", answer: "Zaraz do pana zejdę." },
  { id: 41, category: "Usunąć — to delete, remove", question: "You deleted the last messages.", answer: "Usunął pan ostatnie wiadomości." },
  { id: 42, category: "Zostawić — to leave", question: "I want to leave a tip.", answer: "Chcę zostawić napiwek." },
  { id: 43, category: "Prosić — to ask for", question: "Can I have the bill, please?", answer: "Mogę prosić o rachunek?" },
  { id: 44, category: "Dosiąść się — to join someone", question: "May I join you?", answer: "Mogę się dosiąść?" },
  { id: 45, category: "Stawiać — to put, stand; treat", question: "I’m treating today — it’s on me.", answer: "Ja stawiam." },
  { id: 46, category: "Pożyczyć — to borrow", question: "May I borrow a book from you?", answer: "Mogę pożyczyć od ciebie książkę?" },
  { id: 47, category: "Mimo że — although", question: "Although it was raining, we went for a walk.", answer: "Mimo że padało, poszliśmy na spacer." },
  { id: 48, category: "Natomiast — whereas, on the other hand", question: "I like coffee; my sister, on the other hand, prefers tea.", answer: "Lubię kawę, natomiast moja siostra woli herbatę." },
  { id: 49, category: "Czy — whether, if", question: "I don’t know whether he will come today.", answer: "Nie wiem, czy on dzisiaj przyjdzie." },
  { id: 50, category: "Wcześniej — earlier", question: "I should have checked the project more carefully earlier.", answer: "Wcześniej powinienem dokładniej sprawdzić projekt." },
  { id: 51, category: "Przeciwko — against", question: "I am against this idea because it is too expensive.", answer: "Jestem przeciwko temu pomysłowi, bo jest za drogi." },
  { id: 52, category: "Pod — under", question: "There are air-conditioning pipes under this wall.", answer: "W tej ścianie idą rury od klimatyzacji, proszę uważać." },
  { id: 53, category: "Za — behind, after", question: "The car is parked behind the building.", answer: "Samochód jest zaparkowany za budynkiem." },
  { id: 54, category: "Podobna — similar", question: "My sister looks similar to Adam.", answer: "Moja siostra jest podobna do Adama." },
  { id: 55, category: "Znowu — again", question: "You forgot your keys again.", answer: "Znowu zapomniałeś kluczy." },
  { id: 56, category: "Trzymam kciuki — fingers crossed", question: "Good luck with your exam — fingers crossed!", answer: "Powodzenia na egzaminie — trzymam kciuki!" },
  { id: 57, category: "Najedzony — full, not hungry", question: "Thank you, I’m full and don’t want any more food.", answer: "Dziękuję, jestem najedzony i nie chcę już więcej jedzenia." },
  { id: 58, category: "Zaraz — in a moment", question: "I’ll be there in a moment.", answer: "Zaraz tam będę." },
]
